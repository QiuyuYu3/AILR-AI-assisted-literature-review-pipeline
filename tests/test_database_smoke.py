...
Runs on a throwaway SQLite file; verifies the assembled Database still wires every
domain together (Sources / Screening / ScreeningAux / Extraction / Calibration / Admin).
"""
